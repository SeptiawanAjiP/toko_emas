...
@section('stylesheet')
    <link rel="stylesheet" href="{{ asset('notebook/js/calendar/bootstrap_calendar.css') }}" type="text/css" />
    <!-- css file -->
@endsection
          ...
          <article id="comment-id-2" class="comment-reply">
            <article class="comment-item">
              <a class="pull-left thumb-sm">
                <img src="{{ asset('notebook/images/avatar_default.jpg') }}" class="img-circle">
              </a>
              <section class="comment-body m-b-lg">
                <header>
            ...
            <article class="comment-item">
              <a class="pull-left thumb-sm">
                <img src="{{ asset('notebook/images/avatar.jpg') }}" class="img-circle">
              </a>
              <section class="comment-body m-b-lg">
                <header>
...
@section('script')
    <!-- script file-->
    <script src="{{ asset('notebook/js/charts/easypiechart/jquery.easy-pie-chart.js') }}"></script>
    <script src="{{ asset('notebook/js/charts/sparkline/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('notebook/js/charts/flot/jquery.flot.min.js') }}"></script>
    <script src="{{ asset('notebook/js/charts/flot/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('notebook/js/charts/flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('notebook/js/charts/flot/jquery.flot.grow.js') }}"></script>
    <script src="{{ asset('notebook/js/charts/flot/demo.js') }}"></script>

    <script src="{{ asset('notebook/js/calendar/bootstrap_calendar.js') }}"></script>
    <script src="{{ asset('notebook/js/calendar/demo.js') }}"></script>

    <script src="{{ asset('notebook/js/sortable/jquery.sortable.js') }}"></script>
@endsection
