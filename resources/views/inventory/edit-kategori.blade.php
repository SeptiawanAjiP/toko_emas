...
<section id="content">
  <section class="vbox">
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
                <h3 class="m-b-none">Edit Kategori</h3>
              </div>
              <div class="row">
                <div class="col-sm-9">
                  <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <form role="form" method="POST" action="{{ url('update-category') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                          ...
                          <input id="name" name="name" type="text" class="form-control" placeholder="Masukan nama kategori" value="{{$kategori->name}}">
                        </div>
                        <div class="checkbox">
                          <label>
                            <input id="set_or_no" name="set_or_no" type="checkbox" value="1" 
                              @if($kategori->set_or_no == 1)
                                checked="checked"
                                value="1"
                              @endif 
                            >Bentuk Set
